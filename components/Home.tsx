...
// Use absolute path for the image since we cannot import it as a module in this environment
...
const Home: React.FC = () => {
  ...
  const getTagStyle = (rank: number) => {
    if (rank <= 3) return 'text-2xl md:text-3xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]';
    if (rank <= 8) return 'text-xl md:text-2xl font-bold text-neon-purple drop-shadow-[0_0_5px_rgba(180,108,255,0.6)]';
